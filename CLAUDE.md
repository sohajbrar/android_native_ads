...
This is a WhatsApp Business Android app built with Jetpack Compose and the WhatsApp Design System (WDS). It provides a foundation for rapid prototyping with a complete design system including colors, typography, spacing, corner radius tokens, and reusable components.

**Business App Specifics:**
- Uses dark/warm gray accent colors (#171616 / wdsWarmGray900) instead of green for primary accents
- Warm cream tinted backgrounds (#F7F5F3 / wdsWarmGray75) for selected states
- Persistent green branding (#1DAA61 / wdsGreen500) for badges, status rings, and always-branded elements
- Professional business-focused color palette while maintaining WhatsApp familiarity
...
# WhatsApp Business Android App - LLM Rules

## Project Overview
This is a WhatsApp Business Android app built with Jetpack Compose and the WhatsApp Design System (WDS). It provides a foundation for rapid prototyping with a complete design system including colors, typography, spacing, corner radius tokens, and reusable components.

**Business App Color Scheme:**
- Primary accent: #171616 (wdsWarmGray900) - Used for FAB, primary actions
- Accent deemphasized: #F7F5F3 (wdsWarmGray75) - Used for selected filters, navigation active state
- Accent emphasized: #262524 (wdsWarmGray800) - Used for emphasized actions
- Always branded (green): #1DAA61 (wdsGreen500) - Used for badges, status indicators, timestamps
